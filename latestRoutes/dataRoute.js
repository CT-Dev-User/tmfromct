...
import { deleteMasterClassQueryData, getAllMasterClassQueryData, getMasterClassNames, getMasterClassQueryDataByCategory, getMasterClassQueryDataById, getMasterClassQueryDataByMasterClassName, RegisterForMasterClassData, updateMasterClassQueryData } from '../latestController/masterClass/masterClassRegistration.js';
import { createJobRoleData, deleteJobRoleDataById, getJobRoleData, getJobRoleDataByCategory, getJobRoleDataByCourse, updateJobRoleDataById } from '../latestController/extensiveProgram/jobRoleController.js';
import { createProject, deleteProject, getAllProjects, getProjectByCourse, updateProject } from '../latestController/extensiveProgram/projectController.js';
...
latestRouter.get('/get-by-broucher-by-category/:category/:subCategory', getBroucherByCategory);
...
latestRouter.post('/register-for-master-class', RegisterForMasterClassData); // Create
latestRouter.get('/get-all-master-class-registered-data', getAllMasterClassQueryData); // Get All
latestRouter.get('/get-master-class-registered-data-by-id/:id', getMasterClassQueryDataById); // Get by ID
latestRouter.get('/get-master-class-registered-data-by-masterclass/:masterClassName', getMasterClassQueryDataByMasterClassName);  // Get by masterclassname
latestRouter.get('/get-master-class-registered-data-by-category/:category', getMasterClassQueryDataByCategory);  // Get by masterclassname
latestRouter.get('/get-masterclass/names', getMasterClassNames);  // Get by masterclassname
latestRouter.put('/update-master-class-registered-data/:id', updateMasterClassQueryData); // Update
latestRouter.delete('/delete-master-class-registered-data/:id', deleteMasterClassQueryData); // Delete

latestRouter.post('/add-job-roles', createJobRoleData); // Create a job role
latestRouter.get('/get-job-roles', getJobRoleData); // Get all job roles
latestRouter.get('/get-job-roles/category/:category', getJobRoleDataByCategory); // Get job roles by category
latestRouter.get('/get-job-roles/course/:category/:course', getJobRoleDataByCourse); // Get job roles by course
latestRouter.put('/update-job-roles/:id', updateJobRoleDataById); // Update a job role by ID
latestRouter.delete('/delete-job-roles/:id', deleteJobRoleDataById); // Delete a job role by ID

latestRouter.post('/add-projects', createProject)
latestRouter.get('/get-all-projects', getAllProjects)
latestRouter.get('/get-project-by-course/:category/:course', getProjectByCourse)
latestRouter.put('/update-project-by-id/:id',updateProject)
latestRouter.delete('/delete-project/:id', deleteProject)
